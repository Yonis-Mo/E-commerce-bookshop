		...
		try{
			...
			foreach($stmt as $row){
				...
				$output .= "
					<tr>";
				if($checkout){
					$output .= "		<td><button type='button' data-id='".$row['cartid']."' class='btn btn-danger btn-flat cart_delete'><i class='fa fa-remove'></i></button></td>";
				}
				$output .= "		<td><img src='".$image."' width='30px' height='30px'></td>
						<td>".$row['name']."</td>
